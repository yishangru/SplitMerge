; ModuleID = 'lulesh-viz.cc'
source_filename = "lulesh-viz.cc"
...
@.str = private unnamed_addr constant [59 x i8] c"Must enable -DVIZ_MESH at compile time to call DumpDomain\0A\00", align 1
