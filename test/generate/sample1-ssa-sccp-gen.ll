...
if.end4.dup2:                                     ; preds = %if.else3.dup2, %if.then2.dup2
  ...
  %x.0.dup21 = phi i32 [ %x.0.dup2, %if.else3.dup2 ], [ %x.0.dup2, %if.then2.dup2 ]
...
if.else8.dup2:                                    ; preds = %if.end4.dup2
  %sub9.dup2 = sub nsw i32 %x.0.dup21, 30
...
if.end10.dup2:                                    ; preds = %if.else8.dup2, %if.then6.dup2
  ...
  %y.0.dup22 = phi i32 [ %y.0.dup2, %if.else8.dup2 ], [ %y.0.dup2, %if.then6.dup2 ]
  %x.0.dup23 = phi i32 [ %x.0.dup21, %if.else8.dup2 ], [ %x.0.dup21, %if.then6.dup2 ]
  %add12.dup2 = add nsw i32 10, %x.0.dup23
  %add13.dup2 = add nsw i32 %add12, %y.0.dup22
...
if.then6.dup2:                                    ; preds = %if.end4.dup2
  %add7.dup2 = add nsw i32 %x.0.dup21, 30
  br label %if.end10.dup2
...
if.end4.dup1:                                     ; preds = %if.else3.dup1, %if.then2.dup1
  ...
  %x.0.dup14 = phi i32 [ %x.0.dup1, %if.then2.dup1 ], [ %x.0.dup1, %if.else3.dup1 ]
...
if.else8.dup1:                                    ; preds = %if.end4.dup1
  %sub9.dup1 = sub nsw i32 %x.0.dup14, 30
...
if.end10.dup1:                                    ; preds = %if.else8.dup1, %if.then6.dup1
  ...
  %y.0.dup15 = phi i32 [ %y.0.dup1, %if.then6.dup1 ], [ %y.0.dup1, %if.else8.dup1 ]
  %x.0.dup16 = phi i32 [ %x.0.dup14, %if.then6.dup1 ], [ %x.0.dup14, %if.else8.dup1 ]
  %add12.dup1 = add nsw i32 10, %x.0.dup16
  %add13.dup1 = add nsw i32 %add12, %y.0.dup15
...
if.then6.dup1:                                    ; preds = %if.end4.dup1
  %add7.dup1 = add nsw i32 %x.0.dup14, 30
  br label %if.end10.dup1
}
