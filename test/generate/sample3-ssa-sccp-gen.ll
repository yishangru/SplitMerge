...
while.body.dup1:                                  ; preds = %while.cond.dup1
  %loop.0.dup173 = phi i32 [ %loop.0.dup1, %while.cond.dup1 ]
  %a.0.dup174 = phi i32 [ %a.0.dup1, %while.cond.dup1 ]
  %condition.0.dup175 = phi i32 [ %condition.0.dup1, %while.cond.dup1 ]
  %cmp.dup1 = icmp eq i32 %condition.0.dup175, 0
  br i1 %cmp.dup1, label %if.then.dup0, label %if.else.dup0

if.else.dup0:                                     ; preds = %while.body.dup1, %while.body.dup0
  %loop.0.dup020 = phi i32 [ %loop.0.dup08, %while.body.dup0 ], [ %loop.0.dup173, %while.body.dup1 ]
  %a.0.dup021 = phi i32 [ %a.0.dup09, %while.body.dup0 ], [ %a.0.dup174, %while.body.dup1 ]
  %condition.0.dup022 = phi i32 [ %condition.0.dup010, %while.body.dup0 ], [ %condition.0.dup175, %while.body.dup1 ]
...
if.then.dup0:                                     ; preds = %while.body.dup1, %while.body.dup0
  %loop.0.dup011 = phi i32 [ %loop.0.dup08, %while.body.dup0 ], [ %loop.0.dup173, %while.body.dup1 ]
  %a.0.dup012 = phi i32 [ %a.0.dup09, %while.body.dup0 ], [ %a.0.dup174, %while.body.dup1 ]
  %condition.0.dup013 = phi i32 [ %condition.0.dup010, %while.body.dup0 ], [ %condition.0.dup175, %while.body.dup1 ]
