...
while.body.dup1:                                  ; preds = %while.cond.dup1
  %loop.0.dup17 = phi i32 [ %loop.0.dup1, %while.cond.dup1 ]
  %a.0.dup18 = phi i32 [ %a.0.dup1, %while.cond.dup1 ]
  %condition.0.dup19 = phi i32 [ %condition.0.dup1, %while.cond.dup1 ]
  %cmp.dup1 = icmp eq i32 %condition.0.dup19, 0
  br i1 %cmp.dup1, label %if.then.dup0, label %if.else.dup0

if.else.dup0:                                     ; preds = %while.body.dup1, %while.body.dup0
  %loop.0.dup04 = phi i32 [ %loop.0.dup17, %while.body.dup1 ], [ %loop.0.dup01, %while.body.dup0 ]
  %a.0.dup05 = phi i32 [ %a.0.dup18, %while.body.dup1 ], [ %a.0.dup02, %while.body.dup0 ]
  %condition.0.dup06 = phi i32 [ %condition.0.dup19, %while.body.dup1 ], [ %condition.0.dup03, %while.body.dup0 ]
...
if.then.dup0:                                     ; preds = %while.body.dup1, %while.body.dup0
  %loop.0.dup013 = phi i32 [ %loop.0.dup17, %while.body.dup1 ], [ %loop.0.dup01, %while.body.dup0 ]
  %a.0.dup014 = phi i32 [ %a.0.dup18, %while.body.dup1 ], [ %a.0.dup02, %while.body.dup0 ]
  %condition.0.dup015 = phi i32 [ %condition.0.dup19, %while.body.dup1 ], [ %condition.0.dup03, %while.body.dup0 ]
