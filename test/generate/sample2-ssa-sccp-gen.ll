...
while.body.dup1:                                  ; preds = %while.cond.dup1
  %loop.0.dup127 = phi i32 [ %loop.0.dup1, %while.cond.dup1 ]
  %a.0.dup128 = phi i32 [ %a.0.dup1, %while.cond.dup1 ]
  %cmp.dup1 = icmp sgt i32 %condition, 10
  br i1 %cmp.dup1, label %if.then.dup1, label %if.else.dup1

if.else.dup1:                                     ; preds = %while.body.dup1
  %loop.0.dup141 = phi i32 [ %loop.0.dup127, %while.body.dup1 ]
  %a.0.dup142 = phi i32 [ %a.0.dup128, %while.body.dup1 ]
  %add1.dup1 = add nsw i32 %loop.0.dup141, 2
  br label %if.end.dup0

if.end.dup0:                                      ; preds = %if.else.dup1, %if.else.dup0, %if.then.dup0, %if.then.dup1
  %loop.1.dup0 = phi i32 [ %add1.dup0, %if.else.dup0 ], [ %add1.dup1, %if.else.dup1 ], [ %add.dup1, %if.then.dup1 ], [ %add.dup0, %if.then.dup0 ]
  %a.1.dup0 = phi i32 [ 2, %if.else.dup0 ], [ 2, %if.else.dup1 ], [ 1, %if.then.dup1 ], [ 1, %if.then.dup0 ]
  %add1.dup09 = phi i32 [ undef, %if.then.dup1 ], [ %add1.dup0, %if.else.dup0 ], [ %add1.dup1, %if.else.dup1 ], [ %add1.dup055, %if.then.dup0 ]
  %add.dup010 = phi i32 [ %add.dup1, %if.then.dup1 ], [ %add.dup060, %if.else.dup0 ], [ undef, %if.else.dup1 ], [ %add.dup0, %if.then.dup0 ]
  %loop.0.dup031 = phi i32 [ %loop.0.dup129, %if.then.dup1 ], [ %loop.0.dup056, %if.else.dup0 ], [ %loop.0.dup141, %if.else.dup1 ], [ %loop.0.dup051, %if.then.dup0 ]
  %a.0.dup032 = phi i32 [ %a.0.dup130, %if.then.dup1 ], [ %a.0.dup058, %if.else.dup0 ], [ %a.0.dup142, %if.else.dup1 ], [ %a.0.dup053, %if.then.dup0 ]
...
if.then.dup1:                                     ; preds = %while.body.dup1
  %loop.0.dup129 = phi i32 [ %loop.0.dup127, %while.body.dup1 ]
  %a.0.dup130 = phi i32 [ %a.0.dup128, %while.body.dup1 ]
  %add.dup1 = add nsw i32 %loop.0.dup129, 1
  br label %if.end.dup0
