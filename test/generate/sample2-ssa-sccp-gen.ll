...
while.body.dup1:                                  ; preds = %while.cond.dup1
  %loop.0.dup119 = phi i32 [ %loop.0.dup1, %while.cond.dup1 ]
  %a.0.dup120 = phi i32 [ %a.0.dup1, %while.cond.dup1 ]
  %cmp.dup1 = icmp sgt i32 %condition, 10
  br i1 %cmp.dup1, label %if.then.dup1, label %if.else.dup1

if.else.dup1:                                     ; preds = %while.body.dup1
  %loop.0.dup143 = phi i32 [ %loop.0.dup119, %while.body.dup1 ]
  %a.0.dup144 = phi i32 [ %a.0.dup120, %while.body.dup1 ]
  %add1.dup1 = add nsw i32 %loop.0.dup143, 2
  br label %if.end.dup0

if.end.dup0:                                      ; preds = %if.else.dup1, %if.then.dup0, %if.else.dup0, %if.then.dup1
  %loop.1.dup0 = phi i32 [ %add1.dup1, %if.else.dup1 ], [ %add1.dup0, %if.else.dup0 ], [ %add.dup1, %if.then.dup1 ], [ %add.dup0, %if.then.dup0 ]
  %a.1.dup0 = phi i32 [ 2, %if.else.dup1 ], [ 2, %if.else.dup0 ], [ 1, %if.then.dup1 ], [ 1, %if.then.dup0 ]
  %add1.dup03 = phi i32 [ undef, %if.then.dup1 ], [ %add1.dup1, %if.else.dup1 ], [ %add1.dup061, %if.then.dup0 ], [ %add1.dup0, %if.else.dup0 ]
  %add.dup04 = phi i32 [ %add.dup1, %if.then.dup1 ], [ undef, %if.else.dup1 ], [ %add.dup0, %if.then.dup0 ], [ %add.dup066, %if.else.dup0 ]
  %loop.0.dup023 = phi i32 [ %loop.0.dup121, %if.then.dup1 ], [ %loop.0.dup143, %if.else.dup1 ], [ %loop.0.dup057, %if.then.dup0 ], [ %loop.0.dup062, %if.else.dup0 ]
  %a.0.dup024 = phi i32 [ %a.0.dup122, %if.then.dup1 ], [ %a.0.dup144, %if.else.dup1 ], [ %a.0.dup059, %if.then.dup0 ], [ %a.0.dup064, %if.else.dup0 ]
...
if.then.dup1:                                     ; preds = %while.body.dup1
  %loop.0.dup121 = phi i32 [ %loop.0.dup119, %while.body.dup1 ]
  %a.0.dup122 = phi i32 [ %a.0.dup120, %while.body.dup1 ]
  %add.dup1 = add nsw i32 %loop.0.dup121, 1
  br label %if.end.dup0
